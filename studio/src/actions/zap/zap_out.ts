...
async function main() {
  ...
  // For protocol "dlmm" this is the lbPair address — same --poolAddress flag either way.
  ...
  await zapOut(config, connection, wallet, poolAddress);
}
