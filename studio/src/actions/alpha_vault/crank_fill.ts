...
import { crankFill } from '../../lib/alpha_vault/participant';
...
async function main() {
  ...
  console.log(`- Using wallet ${keypair.publicKey} as the crank payer`);
  ...
  await crankFill(config, connection, wallet, vault);
}
