  ...
  properties: {
    ...
    zapInDammV2: {
      ...
      properties: {
        ...
        amountIn: { type: 'number' },
        slippageBps: { type: 'number' },
        maxSqrtPriceChangeBps: { type: 'number' },
        maxTransferAmountExtendPercentage: { type: 'number' },
        positionMode: { enum: ['new', 'existing'] },
      },
      required: [
        'inputMint',
        'amountIn',
    ...
    zapInDlmm: {
      ...
      properties: {
        inputMint: { type: 'string' },
        amountIn: { type: 'number' },
        swapSlippageBps: { type: 'number' },
        minDeltaId: { type: 'number' },
        maxDeltaId: { type: 'number' },
        strategyType: { type: 'number', enum: [0, 1, 2] },
        singleSided: { anyOf: [{ enum: ['x', 'y'] }, { type: 'null' }] },
        favorXInActiveId: { type: 'boolean' },
        maxActiveBinSlippage: { type: 'number' },
